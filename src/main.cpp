...
////////////////////// Helper Functions //////////////////////
// checks to see if data is a valid number
...
int main()
{
    ...
    vector<string> categories = { "Year", "NA Sales (millions)", "EU Sales (millions)", "JP Sales (millions)", "Other Sales (millions)", "Global Sales (millions)" };
